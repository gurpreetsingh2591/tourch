...
import com.tourch.databinding.ActivityDriverLiceneceBinding
...
class DriverLicenceActivity : AppCompatActivity() {
    private lateinit var binding: ActivityDriverLiceneceBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDriverLiceneceBinding.inflate(layoutInflater)
