...
class HomeVerificationActivity : AppCompatActivity() {
    private lateinit var binding: ActivityDriverHomeVerifiationBinding
    private lateinit var homeVerificationAdapter: HomeVerificationAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDriverHomeVerifiationBinding.inflate(layoutInflater)
    ...
    private fun initRv() {
        ...
        binding.rvVerification.layoutManager = linearLayoutManager
        homeVerificationAdapter = HomeVerificationAdapter(verificationList,"verification",
            object : HomeVerificationAdapter.OnVehicleClick {
                override fun onClick(position: Int) {

                }
            })
        binding.rvVerification.adapter = homeVerificationAdapter
    }
}