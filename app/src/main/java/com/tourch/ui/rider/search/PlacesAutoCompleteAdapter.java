package com.tourch.ui.rider.search;
...
public class PlacesAutoCompleteAdapter extends RecyclerView.Adapter<PlacesAutoCompleteAdapter.PredictionHolder> implements Filterable {
    ...
    private NoResultListener noResultListener;
    ...
    public void setNoResultListener(NoResultListener noResultListener) {
        this.noResultListener = noResultListener;
    }
        ...
        return new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                if (results != null && results.count > 0) {
                    noResultListener.noresult(results.count);
    ...
    public void onBindViewHolder(@NonNull PredictionHolder mPredictionHolder, final int i) {
        mPredictionHolder.tvPlaces.setText(mResultList.get(i).area);
        mPredictionHolder.tvPlacesSub.setText(mResultList.get(i).address);
        mPredictionHolder.ivPlace.setImageResource(R.drawable.ic_location_icon);
    }
    ...
    public class PredictionHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private TextView tvPlaces, tvPlacesSub;
        private ImageView ivPlace;
        private LinearLayout mRow;

        PredictionHolder(View itemView) {
            super(itemView);
            tvPlacesSub = itemView.findViewById(R.id.tvPlacesSub);
            tvPlaces = itemView.findViewById(R.id.tvPlacesMain);
            ivPlace = itemView.findViewById(R.id.ivPlaces);
